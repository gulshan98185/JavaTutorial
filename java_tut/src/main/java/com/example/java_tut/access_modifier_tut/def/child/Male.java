...
public class Male extends Human {
    void access(){
        // in other package within package of Object class in child class ACCESSIBLE = public (by creating object)
        // in other package within package of Object class in child class NOT ACCESSIBLE = default, private, protected(by creating object)


        // in other package within package of Object class in child class NOT ACCESSIBLE = default, private (from parent)
        // in other package within package of Object class in child class ACCESSIBLE = public, protected (from parent)
